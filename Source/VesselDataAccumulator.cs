...
namespace FinePrint
{
    ...
    class VesselDataAccumulator {
        ...
        private void VisitPart(ProtoPartSnapshot p) {
            ...
            // TODO: Stages/delta v
            // there is p.stageIndex  not exactly sure what that contains yet, in particular if it's valid for, say, fuel tanks
            // possibly keep track of fuel and propulsion by stage to calculate total delta v?
